...
export const Email = ({ size = 24, color = '#007BFF', ...props }: IconProps) => (
  <Svg
    ...
    <Path
      fill={color}
      d="M1 7.357V1.643l3.767 2.583a2.171 2.171 0 0 0 2.466 0L11 1.643v5.714C11 7.93 10.444 8.5 9.889 8.5H2.11C1.556 8.5 1 7.929 1 7.357Z"
    />
    <Path
      stroke={color}
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M1 1.643C1 1.07 1.556.5 2.111.5H9.89C10.444.5 11 1.071 11 1.643m-10 0v5.714C1 7.93 1.556 8.5 2.111 8.5H9.89C10.444 8.5 11 7.929 11 7.357V1.643m-10 0 3.767 2.583a2.171 2.171 0 0 0 2.466 0L11 1.643"
    />
    <Path
      stroke="#fff"
      strokeWidth={0.8}
